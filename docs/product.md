...
- Key UX: split panes, keybinding customization, workspace model, in-app browser, collapsible per-turn work traces (tools and reasoning) after each assistant reply, per-turn file-change summary cards with Review into Changes
