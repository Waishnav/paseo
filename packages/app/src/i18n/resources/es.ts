...
export const es: TranslationResources = {
  ...
  agentStream: {
    ...
    fileChanges: {
      ...
      createdFiles: "Creó {{count}} archivos",
      deletedFiles: "Eliminó {{count}} archivos",
      changedFiles: "Cambió {{count}} archivos",
      lineChanges: "{{additions}} adiciones, {{deletions}} eliminaciones",
      review: "Revisar",
      andMore: "y {{count}} más",
    },
    permission: {
